...
const handleLogin = async (e) => {
  ...
  try {
    const res = await fetch("https://bluen-crm-back.onrender.com/api/auth/login", {
      method: "POST",
...
const handleRegister = async (e) => {
  ...
  try {
    const res = await fetch("https://bluen-crm-back.onrender.com/api/auth/register", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Bluen CRM</h1>
          <p className="text-gray-600">Gerenciador do Agente SDR</p>
        </div>
        ...
        <div className="text-center mt-8">
          <p className="text-sm text-gray-500">
            © 2024 Bluen CRM. Todos os direitos reservados.
          </p>
